...
import com.registro.usuarios.app.modelo.Rol;
import com.registro.usuarios.app.modelo.Usuario;
import com.registro.usuarios.app.repositorio.UsuarioRepositorio;
...
public class UsuarioServicioImpl implements UsuarioServicio {
	...
	public Usuario guardar(UsuarioRegistroDTO registroDTO) {
		Usuario usuario = new Usuario(registroDTO.getCedula(), registroDTO.getNombre(), registroDTO.getApellido(),
				registroDTO.getFechaNacimiento(), registroDTO.getTelefono(), registroDTO.getSexo(),
